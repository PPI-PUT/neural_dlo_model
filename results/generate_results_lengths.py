...
def boxplot(data, field):
    ...
    v = v45_t45 + v50_t45 + v50_t45s + v40_t40 + v50_t40 + v50_t40s
    n_groups = 6
    keys = order * n_groups
    width = 0.25
    shift = 3 * width
    ...
    ax.legend(custom_lines, ['Transformer', "IN-biLSTM", 'MLP'],
             bbox_to_anchor=(0.85, 0.0), frameon=False, ncol=3)
    ...
    ax.text(0.24, 0.89, 'Tested on 45cm', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    ax.text(0.76, 0.89, 'Tested on 40cm', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    ax.text(0.09, -0.02, '45cm', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    ax.text(0.24, -0.02, '50cm', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    ax.text(0.39, -0.02, '50cm+scale', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    ax.text(0.61, -0.02, '40cm', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    ax.text(0.76, -0.02, '50cm', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    ax.text(0.91, -0.02, '50cm+scale', verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes)
    plt.show()
